...
x1 = layers.Dense(256, name='FC-pre-z_mean', activation = "relu")(x)
x2 = layers.Dense(256, name='FC-pre-z_log_var', activation = "relu")(x)
z_mean = layers.Dense(latent_dim, name='z_mean')(x1)
z_log_var = layers.Dense(latent_dim, name='z_log_var')(x2)
