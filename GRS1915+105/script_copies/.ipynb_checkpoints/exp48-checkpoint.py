...
with open('series_43023_500.pkl', 'rb') as f:
...
deep_model.add(CuDNNGRU(80, input_shape=(500,1), return_sequences=False))
...
history = deep_model.fit(segments, segments, epochs=8000, verbose=2, callbacks = [MC, CB], validation_split=0.05, batch_size=384)
