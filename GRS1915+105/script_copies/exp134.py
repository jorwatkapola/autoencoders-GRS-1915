...
h_enc = CuDNNLSTM(64, return_sequences=False)(y_in)
...
h_dec = CuDNNLSTM(64, return_sequences=True)(h_dec)
...
history = model.fit(x=segments, y=segments, batch_size=2048, epochs=8000, verbose=2, callbacks = [MC, CB], validation_split=0.5)
