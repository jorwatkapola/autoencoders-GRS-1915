...
with open('../../data_GRS1915/468202_len128_s2_4cad_histograms_32bin_0-13k_errorfix.pkl', 'rb') as f:
...
history = vae.fit(x=segments, y=segments, batch_size=4096, epochs=8000, verbose=2, callbacks = [MC, CB], validation_split=0.05)
