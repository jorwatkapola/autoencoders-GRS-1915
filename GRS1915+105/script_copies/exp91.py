...
with open('../../data_GRS1915/48493_len256_stride16_4sec_counts.pkl', 'rb') as f:
    segments = pickle.load(f)
with open('../../data_GRS1915/48493_len256_stride16_4sec_errors.pkl', 'rb') as f:
...
h_enc = CuDNNLSTM(2048, return_sequences=False)(y_in)
...
h_dec = CuDNNLSTM(2048, return_sequences=True)(h_dec)
