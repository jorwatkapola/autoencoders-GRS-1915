...
with open('../../data_GRS1915/509201_len96_stride8_4sec_cad_counts_errorfix.pkl', 'rb') as f:
    segments = pickle.load(f)
with open('../../data_GRS1915/509201_len96_stride8_4sec_cad_errors_errorfix.pkl', 'rb') as f:
...
with open('../../data_GRS1915/509201_len96_stride8_4sec_cad_observation75-25split.pkl', 'rb') as f:
...
optimizer = tf.keras.optimizers.SGD(lr=1.5e-4, clipvalue=0.5) #Adam(clipvalue=0.5) 
...
vae.load_weights("../../model_weights/model_2020-11-21_15-43-16.h5")
