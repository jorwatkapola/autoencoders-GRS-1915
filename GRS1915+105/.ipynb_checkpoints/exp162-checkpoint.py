...
optimizer = tf.keras.optimizers.SGD(lr=1.2e-3, clipvalue=0.5) #Adam(clipvalue=0.5)
...
vae.load_weights("../../model_weights/model_2020-11-22_14-48-38.h5")


    
# Training and Validation generators in a 75/25 split
