...
h_enc = CuDNNGRU(64, return_sequences=False)(h_enc)
# h_enc = BatchNormalization()(h_enc)
h_enc = Dense(64, activation=None, name='bottleneck')(h_enc)
# h_enc = BatchNormalization()(h_enc)
